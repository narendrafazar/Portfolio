...
// ga usah bikin controller baru buat success, gabungin aja ama CartController, biar ga kebanayakan controller aja
...
Route::group(['middleware' => ['auth']], function() {
    ...
    // redirect untuk ke halaman sebelumnya, misalnya lagi ada di edit store, maka redirectnya ke edit store
