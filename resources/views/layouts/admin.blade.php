...
<html lang="en">
  ...
  <body>
      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush">
            ...
            {{-- {{ (request()->is('admin/category*')) ? 'active' : '' }} buat mastiin kalo lagi di halaman admin category atau seterusnya dengan *, maka bakalan jadi active (nyala), kalo ngga, ya ngga active --}}
    ...
    {{-- Pake datatables gabisa pake jquery slim, jadi slimnya di apus --}}
