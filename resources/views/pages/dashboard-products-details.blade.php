                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      {{-- membuat output berupa html dengan {!!  !!} --}}
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="gallery-container">
                    <!-- class w-100 biar gambarnya full gede sekolom -->
                ...
                <div class="col-12">
                  {{-- untuk upload gambar disarankan pake enctype multipart --}}
                  <form action="{{ route('dashboard-product-gallery-upload') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="products_id" value="{{ $product->id }}">
                    {{-- onChange="form.submit()" berguna agar ketika ngeklik gambar, langsung ke submit --}}
